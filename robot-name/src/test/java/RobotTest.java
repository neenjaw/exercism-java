...
public class RobotTest {
    ...
    @Before
    public void setUp() throws FullRegistryException {
        robot = new Robot();
    }
    ...
    @Test
    public void differentRobotsHaveDifferentNames() throws FullRegistryException {
        assertThat(robot.getName(), not(equalTo(new Robot().getName())));
    }

    // @Ignore("Remove to run test")
    @Test
    public void resetName() throws FullRegistryException {
